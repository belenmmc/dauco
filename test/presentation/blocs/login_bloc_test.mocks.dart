...
// in dauco/test/presentation/blocs/login_bloc_test.dart.
...
import 'package:dauco/data/repositories/implementation/user_repository.dart'
    as _i2;
import 'package:dauco/domain/usecases/login_use_case.dart' as _i3;
...
class MockLoginUseCase extends _i1.Mock implements _i3.LoginUseCase {
  ...
  @override
  _i4.Future<void> execute(String? email, String? password) =>
      (super.noSuchMethod(
