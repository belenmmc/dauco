...
// in dauco/test/presentation/blocs/import_users_bloc_test.dart.
...
import 'package:dauco/domain/usecases/import_users_use_case.dart' as _i3;
...
/// A class which mocks [ImportUsersUseCase].
///
/// See the documentation for Mockito's code generation for more information.
class MockImportUsersUseCase extends _i1.Mock
    implements _i3.ImportUsersUseCase {
  MockImportUsersUseCase() {
  ...
  @override
  _i4.Future<List<_i5.ImportedUser>> execute(
    dynamic file, {
    int? page = 1,
    int? pageSize = 10,
  }) =>
      (super.noSuchMethod(
            ...
            returnValue: _i4.Future<List<_i5.ImportedUser>>.value(
              <_i5.ImportedUser>[],
            ),
          )
          as _i4.Future<List<_i5.ImportedUser>>);
}
