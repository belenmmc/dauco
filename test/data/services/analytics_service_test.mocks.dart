...
// in dauco/test/data/services/analytics_service_test.dart.
...
class _FakePostgrestQueryBuilder_9<T1> extends _i1.SmartFake
  ...
  _FakePostgrestQueryBuilder_9(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class _FakePostgrestTransformBuilder_13<T1> extends _i1.SmartFake
  ...
  _FakePostgrestTransformBuilder_13(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _FakeResponsePostgrestBuilder_14<T1, S, R> extends _i1.SmartFake
    implements _i2.ResponsePostgrestBuilder<T1, S, R> {
  _FakeResponsePostgrestBuilder_14(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
